...
import 'package:gocar/src/entity/motorista.entity.dart';
import 'package:gocar/src/entity/passageiro.entity.dart';
...
class Viagem {
  ...
  Viagem.fromSnapshotJson(DocumentSnapshot snapshot)
      : this.Id = snapshot.documentID,
        ...
        this.Status = StatusViagem.values[(snapshot.data["Status"])];
