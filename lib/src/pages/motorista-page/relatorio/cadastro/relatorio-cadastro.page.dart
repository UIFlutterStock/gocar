...
class RelatorioCadastroPage extends StatefulWidget {
  String idRelatorio;

  RelatorioCadastroPage(this.idRelatorio);

  @override
  _RelatorioCadastroPageState createState() => _RelatorioCadastroPageState();
}

class _RelatorioCadastroPageState extends State<RelatorioCadastroPage> {
