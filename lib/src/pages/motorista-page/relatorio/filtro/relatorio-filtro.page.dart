...
class _RelatorioListagemPageState extends State<RelatorioListagemPage> {
  ...
  String _dataInicial = "Inicio";
  String _dataFinal = "Fim";
  ...
  filtraDados() {
    if (_dataInicial == null ||
        ...
        _dataInicial == 'Inicio') {
      ShowSnackBar.build(
          _scaffoldKey, 'Adicione a data inicial !', context);
      return;
    }

    if (_dataFinal == null || _dataFinal == '' || _dataFinal == 'Fim') {
      ShowSnackBar.build(
          _scaffoldKey, 'Adicione a data final !', context);
      return;
    }
