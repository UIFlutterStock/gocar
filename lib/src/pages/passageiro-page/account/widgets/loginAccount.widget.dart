  ...
  void _functionLoginWithGoogle(BuildContext context) {
    ...
    _auth.signWithGoogle().then((r) {
      ...
      switch (ex.code) {
        case "ERROR_WRONG_PASSWORD":
          ShowSnackBar.build(
              widget._scaffoldLoginKey, 'User or Password incorret!', context);
          break;
        case "ERROR_INVALID_EMAIL":
          ShowSnackBar.build(
              widget._scaffoldLoginKey, 'Email invalid!', context);
          break;
        default:
          ShowSnackBar.build(
              widget._scaffoldLoginKey, 'Sorry, a problem happened!', context);
          break;
      }
    });
  }
              ...
              children: <Widget>[
                _buildFacebookGoogleButton(
                  ...
                  ShowSnackBar.build(
                      ...
                      'Atualmente somente é possivel realizar login com conta Google ou com E-mail!',
                      context);
                  return false;
