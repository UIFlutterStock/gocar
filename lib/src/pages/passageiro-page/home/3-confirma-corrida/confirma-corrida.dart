...
class ConfirmaCorridaPassageiro extends StatelessWidget {
                              ...
                              child: MaterialButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    _homeBloc.stepProcessoEvent.add(
                                        StepPassageiroHome.ProcurandoMotorista);
          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                    "R\$${(TipoCarro.Pop == tipo ? viagem.ValorPop : viagem.ValorTop).toStringAsFixed(2)}  ",
                    /*"\$\8.05  "*/
                    style: TextStyle(
                        fontFamily: 'roboto',
                        fontSize: 16.0,
