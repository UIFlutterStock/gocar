...
class SelecionarDestinoOrigemWidget extends StatefulWidget {
  @override
  _SelecionarDestinoOrigemWidgetState createState() =>
      _SelecionarDestinoOrigemWidgetState();
}

class _SelecionarDestinoOrigemWidgetState
    extends State<SelecionarDestinoOrigemWidget> {
  ...
  _validaProximaEtapa() async {
    ...
    if (provider.EnderecoOrigem.isNotEmpty &&
      ...
      _googleService
        ...
        _homeBloc.stepProcessoEvent.add(StepPassageiroHome.ConfirmaValor);
                        ...
                        onChanged: (value) {
                          if (value != null && value.isNotEmpty)
                            _autoCompleteBloc.searchEvent
                                .add(Filtro(value, ReferenciaLocal.Origem));
                        },
                        style: TextStyle(
                            fontSize: 16.0,
                            color: Colors.black,
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (value) {
                          if (value != null && value.isNotEmpty)
                            _autoCompleteBloc.searchEvent
                                .add(Filtro(value, ReferenciaLocal.Destino));
                        },
                        style: TextStyle(
                            fontSize: 16.0,
                            color: Colors.black,
                  ...
                  builder: (BuildContext context,
                    ...
                    if ((passageiro.Casa != null &&
                      ...
                      return Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            _buildLocal(TipoLocal.casa),
                            _buildLocal(TipoLocal.trabalho),
                          ],
                        ),
                      );
                    } else {
                        ...
                        children: snapshot.data
                            .map((data) => GestureDetector(
                                  onTap: () {
                                    ...
                                    if (data.referencia ==
                                        ReferenciaLocal.Origem) {
                                      origemController.text = data.Nome;
                                      _baseBloc.refreshProvider(latlng,
                                          data.Nome, ReferenciaLocal.Origem);
                                    } else {
                                      _baseBloc.refreshProvider(latlng,
                                          data.Nome, ReferenciaLocal.Destino);
  ...
  _buildLocal(TipoLocal tipoLocal) => StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<Passageiro> snapshot) {
        ...
        if (TipoLocal.casa == tipoLocal &&
            (passageiro.Casa == null || passageiro.Casa.Nome == null))
          return Container(height: 1, width: 1);

        if (TipoLocal.trabalho == tipoLocal &&
        ...
        return Expanded(
            ...
            if (tipoLocal == TipoLocal.casa) {
              ...
              if (origemFocus.hasFocus) {
                _baseBloc.refreshProvider(
                    latlng, passageiro.Casa.Nome, ReferenciaLocal.Origem);
                origemController.text = passageiro.Casa.Nome;
              } else {
                _baseBloc.refreshProvider(
                    latlng, passageiro.Casa.Nome, ReferenciaLocal.Destino);
              ...
              if (origemFocus.hasFocus) {
                _baseBloc.refreshProvider(
                    latlng, passageiro.Trabalho.Nome, ReferenciaLocal.Origem);
                origemController.text = passageiro.Trabalho.Nome;
              } else {
                _baseBloc.refreshProvider(
                    latlng, passageiro.Trabalho.Nome, ReferenciaLocal.Destino);
          ...
          child: Container(
            margin: TipoLocal.casa == tipoLocal
            ...
            child: Row(
              ...
              children: <Widget>[
                Container(
                    ...
                    child: Icon(
                        Feather.getIconData(
                            tipoLocal == TipoLocal.casa ? 'home' : 'briefcase'),
                ...
                Column(
                  ...
                  children: <Widget>[
                    Padding(
                      padding: TipoLocal.casa == tipoLocal
                          ...
                          : (passageiro.Trabalho != null &&
                              ...
                              : EdgeInsets.only(top: 15, left: 10)),
                      child: Text(
                        tipoLocal == TipoLocal.casa ? 'Casa' : 'Trabalho',
                        textAlign: TextAlign.left,
                      ),
                    ),
                    (TipoLocal.casa == tipoLocal &&
                            passageiro.Casa != null &&
                            passageiro.Casa.Nome != null)
                        ? Padding(
