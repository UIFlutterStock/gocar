...
class MotoristaEncontradoWidget extends StatelessWidget {
  GlobalKey<ScaffoldState> scaffoldKey;

  MotoristaEncontradoWidget(this.scaffoldKey);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<Viagem> snapshot) {
          ...
          if (viagem?.Id == null || viagem.Status == StatusViagem.Cancelada)
            return Container(
              height: 1,
              width: 1,
            );
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(
                              'O motorista está a caminho, aguarde .Se você deseja mudar sua viagem, você pode cancelar '
                              'gratuitamente antes de ${cancelarAte}.',
                            ...
                            child: MaterialButton(
                                ...
                                onPressed: () async {
                                  if (DateTime.now().isAfter(timelimite)) {
                                    ShowSnackBar.build(
                                        scaffoldKey,
                                        'Desculpe a viagem não pode ser cancelada pelo aplicativo, o'
                                        ' tempo para cancelamento acabou ,aguarde o motorista e cancele pessoalmente!',
                                        context);
                                    return;
                                  }
