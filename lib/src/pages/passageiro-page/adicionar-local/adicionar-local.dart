...
class AdicionarLocalPage extends StatefulWidget {
  const AdicionarLocalPage(this.tipoLocal);

  final TipoLocal tipoLocal;

  @override
  _AdicionarLocalPageState createState() => _AdicionarLocalPageState();
}

class _AdicionarLocalPageState extends State<AdicionarLocalPage> {
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelText: "Digite aqui endereço !",
                          hintStyle: TextStyle(
                              fontFamily: FontStyleApp.fontFamily(),
                              fontSize: 18.0),
                        ),
                ...
                children: snapshot.data
                    .map((data) => GestureDetector(
                          onTap: () {
                            ...
                            if (widget.tipoLocal == TipoLocal.casa) {
