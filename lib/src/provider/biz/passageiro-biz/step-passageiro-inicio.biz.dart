...
class StepPassagieroInicioBiz {
  static StepPassagieroInicioBiz _instance;

  factory StepPassagieroInicioBiz() {
    _instance ??= StepPassagieroInicioBiz._internalConstructor();
    return _instance;
  }

  StepPassagieroInicioBiz._internalConstructor();
