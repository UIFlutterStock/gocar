...
class StepConfirmaCorridaBiz {
  static StepConfirmaCorridaBiz _instance;

  factory StepConfirmaCorridaBiz() {
    _instance ??= StepConfirmaCorridaBiz._internalConstructor();
    return _instance;
  }

  StepConfirmaCorridaBiz._internalConstructor();
