...
class StepMotoristaViagemIniciada {
  ...
  static StepMotoristaViagemIniciada _instance;

  factory StepMotoristaViagemIniciada() {
    _instance ??= StepMotoristaViagemIniciada._internalConstructor();
    return _instance;
  }

  StepMotoristaViagemIniciada._internalConstructor();
  ...
  Future<void> Start() async {
    ...
    _homeBloc.stepMotoristaEvent.add(StepMotoristaHome.Fimviagem);
    ...
    _streamSpecificaViagem = streamViagemEspecifica.listen((data) {
      data.documentChanges.forEach((changeResult) async {
        ...
        if (viagemEspefica.Status == StatusViagem.Finalizada) {
          /*encerra fluxo */
