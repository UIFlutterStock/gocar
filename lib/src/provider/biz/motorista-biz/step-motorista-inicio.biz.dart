...
class StepMotoristaInicioBiz {
  static StepMotoristaInicioBiz _instance;

  factory StepMotoristaInicioBiz() {
    _instance ??= StepMotoristaInicioBiz._internalConstructor();
    return _instance;
  }

  StepMotoristaInicioBiz._internalConstructor();
